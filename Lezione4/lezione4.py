...
def fav_book(title: str) -> None:
    message: str = f"One of my favourite book is {title}"
    print(message)
...
def make_shirt_1(size: str = "L", text: str = "I love Python") -> None:
    message: str = f"Size: {size}\nText: {text}"
    print(message)
...
def show_message(message: list) -> None:
    for t in message:
        print(t)
...
def make_car(manufacturer: str, model: str, color: str = None, parking_sensor: bool = False) -> dict:
...
def store_car(manufacturer: str, model: str, color: str = "Nero", optional: str = "Sensori posteriori") -> dict:
